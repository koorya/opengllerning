...
void MainFrame::calcMatrices(){
	...
	this->rail1 = glm::translate(this->A, glm::vec3(3300.0, 6760.0, -400.0));
	this->rail2 = glm::translate(this->A, glm::vec3(3300.0 + 2255.0, -245.0, -400.0));
	this->rail3 = glm::translate(this->A, glm::vec3(3300.0, -7250.0, -400.0));
}
