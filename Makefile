...
obj/main.o: src/main.cpp 
	g++ -Wall -c -DFULL_SCREEN_ -Ic:/opengl/include -I"C:\mysql-connector-c-6.0.2-mingw32\include" src/main.cpp -o obj/main.o
...
obj/remote_manipulator.o: src/remote_manipulator.cpp src/remote_manipulator.h
	g++ -Wall -c -Ic:/opengl/include -I"C:\mysql-connector-c-6.0.2-mingw32\include" src/remote_manipulator.cpp -o obj/remote_manipulator.o
